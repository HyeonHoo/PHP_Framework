...
<script>
       function find_text()
		{                              
			form1.action="/~sale53/jaegoi/lists/text1/" + form1.text1.value+"/page";
			form1.submit();
		}
		...
		<form name="form1" action="" method="post">
			<div class="row">
				...
				<div class="col-12" align="right">           
					   <a href="/~sale53/jaegoi/add<?=$tmp; ?>" class="btn btn-sm btn-dark">추가</a>
		  ...
		  <tbody>
			<tr>
			 ...
			 <td><?=$row->writeday53 ?></a></td>
			  <td><a href="/~sale53/jaegoi/view/no/<?=$no;?> <?=$tmp; ?>"><?=$row->music_title53 ?></a></td>
...
<!---------------------
	<table class="table  table-bordered  table-sm  mymargin5">
		...
		<tr>
			<td><?=$row->no53 ?></td>
			<td><?=$row->writeday53 ?></a></td>
			<td align="lefft"><a href="/~sale53/jaegoi/view/no/<?=$no;?> <?=$tmp; ?>"><?=$row->music_name53 ?></a></td>
