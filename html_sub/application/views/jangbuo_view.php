...
?>
	...
	<tr>
			...
			<td width="80%" align="left">
				<div class="form-inline"><?=$row->numo53 ?></div>
			</td>
		</tr>
			<tr>
		...
		<div align="center">
		<a href="/~sale53/jangbuo/edit<?=$tmp ?>" class="btn btn-sm mycolor1">수정</a>
		<a href="/~sale53/jangbuo/del<?=$tmp ?>" class="btn btn-sm mycolor1" onClick="return confirm('삭제할까요 ?');">삭제</a>&nbsp;
