...
<script>
       function find_text()
		{                              
			form1.action="/~sale53/jangbuo/lists/text1/" + form1.text1.value+"/page";
			form1.submit();
		}
...
<?     $tmp = $text1 ? "/text1/$text1/page/$page" : "/page/$page";  ?>
		...
		<form name="form1" action="" method="post">
			<div class="row">
				...
				<div class="col-9" align="right">           
					   <a href="/~sale53/jangbuo/add<?=$tmp; ?>" class="btn btn-sm mycolor1">추가</a>
				</div>
			</div>
		</form>
	...
	<table class="table  table-bordered  table-sm  mymargin5">
		...
		<tr>
			...
			<td align="lefft"><a href="/~sale53/jangbuo/view/no/<?=$no;?> <?=$tmp; ?>"><?=$row->product_name53 ?></a></td>
			<td align="rigth"><?=number_format($row->price53) ?></a></td>
			<td align="rigth"><?=number_format($row->numo53) ?></a></td>
