		...
		<tr>
			...
			<td width="80%" align="left">
				...
				<?
					...
					foreach ($list as $row)
					{
						if ($row->no53==$product_no)
							echo("<option value='$row->no53^^$row->price53' selected>$row->name53($row->price53) </option>");
						else
							echo("<option value='$row->no53^^$row->price53'>$row->name53($row->price53) </option>");
					}
				?>
				</select>
				</div>
		...
		<tr> 
			...
			<td width="80%" align="left">
				<div class="form-inline">
					<input  type="text" name="price" value=""  class="form-control form-control-sm"
						onChange='cal_prices();'>
				</div>
			</td>
		</tr>
		<tr> 
			...
			<td width="80%" align="left">
				<div class="form-inline">
					<input  type="text" name="numi" value="" class="form-control form-control-sm"
					onChange='cal_prices();'>
				</div>
			</td>
		</tr>
		<tr> 
			...
			<td width="80%" align="left">
				<div class="form-inline">
					<input  type="text" name="prices" value="" class="form-control form-control-sm"
