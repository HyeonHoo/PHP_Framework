	...
	<form name="form1" method="post" action="" enctype="multipart/form-data">
		...
		<div style="width:1100px; height:200px; float:left;">
		  ...
		  <tr>
			  ...
			  <td>
					...
					<input  type="text" name="title"  class="form-control form-control-sm" size="20" maxlength="20" 
					value="<?=$row->title53; ?>"  class="form-control form-control-sm">
		...
		<tr>
			...
			<tr>
			  ...
			  <td>
				<div class="form-inline">
					<input  type="text" name="jaego"  class="form-control form-control-sm" size="20" maxlength="20" value="<?=$row->jaego53; ?>" class="form-control form-control-sm">
			...
			<tr>
			  ...
			  <td>
					<div class="form-inline">
					<b>파일이름</b> : <?=$row->music_file53; ?> &nbsp;&nbsp;
					<input  type="file" name="music_file" value="" size="20" class="form-control form-control-sm"> <br>
						 <?
					if ($row->music_file53)     // 이미지가 있는 경우
						echo("<img src='/~sale53/music_fe/$row->music_file53' width='200' class='form-control form-control-sm'>");
					else                   // 이미지가 없는 경우
						echo("<img src='' width='200' class='form-control form-control-sm'>");
				?>
				</div>
				</td>
			</tr>
