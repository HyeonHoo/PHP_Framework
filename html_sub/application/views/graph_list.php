		...
		function find_text()
		{
			form1.action="/~sale53/graph/lists/text1/" + form1.text1.value + "/text2/" + form1.text2.value ;
			form1.submit();
		}
		...
		foreach($list as $row)
		{
			$str_label .= " '$row->gubun_name53' , ";
			$str_data .= $row->cnumo . ' , ';
		}
	?>
	
	<script src="/~sale53/my/js/Chart.js"></script>
	<script src="/~sale53/my/js/utils.js"></script>
