...
<title>Music</title>
	<script src="/~sale53/my/css/music.view.css"></script>
	...
	<script src="/~sale53/my/js/music.view.js"></script>
...
<body>
    <div class="container-fluid">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light ">
				...
				<li class="nav-item">
						<a class="nav-link" href="/~sale53/music/add">업로드</a>
					</li>
				</ul>
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="5000">
			  ...
			  <div class="carousel-inner">
				<div class="carousel-item active">
				  <img src="/~sale53/my/img/playlist1.jpg" class="d-block w-100" alt="First slide" height="500">
				</div>
				<div class="carousel-item">
				 <img src="/~sale53/my/img/playlist5.jpg" class="d-block w-100" alt="Second slide" height="500">
				</div>
				<div class="carousel-item">
				 <img src="/~sale53/my/img/playlist6.jpg" class="d-block w-100" alt="Third slide" height="500">
				</div>
			  </div>
