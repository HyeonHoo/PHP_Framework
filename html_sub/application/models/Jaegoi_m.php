<?
    class Jaegoi_m extends CI_Model     // 모델 클래스 선언
    {
        public function getlist($text1,$text2,$start,$limit)
        {
				$sql="select playlist.*, music.title53 as music_title53 
				  ...
				  where playlist.mu53=0 and playlist.writeday53 between '$text1' and '$text2' 
		...
		{
			$sql="select * from playlist where mu53=0 and playlist.writeday53 between '$text1' and '$text2' ";
